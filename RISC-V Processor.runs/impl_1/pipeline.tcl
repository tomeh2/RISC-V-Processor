...
namespace eval ::optrace {
  variable script "E:/Vivado Projects/RISC-V Processor/RISC-V Processor.runs/impl_1/pipeline.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{E:/Vivado Projects/RISC-V Processor/RISC-V Processor.runs/synth_1/pipeline.dcp}}
