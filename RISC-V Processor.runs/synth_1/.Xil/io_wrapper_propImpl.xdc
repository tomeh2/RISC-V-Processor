set_property SRC_FILE_INFO {cfile:{e:/Vivado Projects/RISC-V Processor/RISC-V Processor.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.xdc} rfile:{../../../RISC-V Processor.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.xdc} id:1 order:EARLY scoped_inst:cpu_main_clk/inst} [current_design]
set_property SRC_FILE_INFO {cfile:{E:/Vivado Projects/RISC-V Processor/RISC-V Processor.srcs/constrs_1/new/io_constraints.xdc} rfile:{../../../RISC-V Processor.srcs/constrs_1/new/io_constraints.xdc} id:2} [current_design]
current_instance cpu_main_clk/inst
