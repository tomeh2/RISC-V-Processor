...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../RISC-V\\ Processor.gen/sources_1/ip/ila_1/hdl/verilog" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../RISC-V Processor.gen/sources_1/ip/ila_1/sim/ila_1.vhd" \
  2>&1 | tee -a vhdlan.log
